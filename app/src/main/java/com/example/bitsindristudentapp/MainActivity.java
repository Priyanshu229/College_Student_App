package com.example.bitsindristudentapp;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
       /* switch (item.getItemId()) {
            ...
            case R.id.navigation_rate:
                Toast.makeText(this, "6000/- ", Toast.LENGTH_SHORT).show();
                break;
            case R.id.navigation_ebook:
                Toast.makeText(this, "Ebooks", Toast.LENGTH_SHORT).show();
                break;
            case R.id.navigation_theme:
                Toast.makeText(this, "change themes", Toast.LENGTH_SHORT).show();
                break;
            case R.id.navigation_website:
                Toast.makeText(this, "website here", Toast.LENGTH_SHORT).show();
                break;
        }*/
